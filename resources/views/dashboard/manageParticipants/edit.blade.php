    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-light dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('userManagement.show') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
    ...
    <div class="p-4 sm:ml-64">
        @if (session('success'))
            <div id="toast-success"
                class="fixed z-50 top-2 right-4 flex items-center w-full max-w-md mx-auto p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                role="alert">
                <div
                ...
                <div class="ms-3 text-sm font-normal"> {{ session('success') }}
                </div>
                <button type="button"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <form class="max-w-6xl mx-auto w-full p-4" action="{{ route('manage-participants.update', $user->id) }}"
                method="post">
                @csrf
                @method('put')
                <p
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="nim" name="nim"
                        ...
                        placeholder="A11.2000.12345" value="{{ $user->nim }}" required />
                </div>
                <div class="mb-5">
                    <label for="name"
