...
@section('content')
    <section id="content" class="w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        <div id="image-details" class="flex flex-col gap-3 px-4">
            <div class="w-full h-[345px] flex shrink-0 rounded-xl overflow-hidden">
                <img id="image-thumbnail" src="assets/thumbnails/nusa-penida.jpg"
                    class="object-cover object-center w-full h-full" alt="thumbnail">
            </div>
            <div class="grid grid-cols-4 gap-4 mx-auto w-fit">
                <a href="assets/thumbnails/nusa-penida.jpg"
                    class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto border-blue">
                    <img src="assets/thumbnails/nusa-penida.jpg" class="object-cover object-center w-full h-full"
                        alt="thumbnail">
                </a>
                <a href="assets/thumbnails/nusa-penida2.jpg"
                    class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                    <img src="assets/thumbnails/nusa-penida2.jpg" class="object-cover object-center w-full h-full"
                        alt="thumbnail">
                </a>
                <a href="assets/thumbnails/nusa-penida3.jpg"
                    class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                    <img src="assets/thumbnails/nusa-penida3.jpg" class="object-cover object-center w-full h-full"
                        alt="thumbnail">
                </a>
                <a href="assets/thumbnails/nusa-penida4.jpg"
                    class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                    <img src="assets/thumbnails/nusa-penida4.jpg" class="object-cover object-center w-full h-full"
                        alt="thumbnail">
                </a>
            </div>
        </div>
            ...
            <div class="flex justify-between gap-2">
                <div class="flex items-center gap-2">
                    <div class="flex items-center w-6 h-6 shrink-0">
                        <img src="assets/icons/location-map.svg" class="object-contain w-full h-full" alt="icon">
                    </div>
                    <div class="flex flex-col gap-1">
                        <p class="text-sm leading-[22px] tracking-[0.35px] text-darkGrey">Location</p>
                        <p class="text-sm font-semibold tracking-035">Bali, Indonesia</p>
                    </div>
                </div>
                <div class="flex flex-col gap-1">
        ...
        <div class="mx-4 flex flex-col gap-3 bg-white p-[16px_24px] rounded-[22px]">
            ...
            <p id="seeLess" class="hidden text-sm leading-[22px] tracking-035 text-darkGrey">
                Picturesque destination renowned for its stunning coastal views and pristine white sand Lorem ipsum dolor,
                sit amet consectetur adipisicing elit. Incidunt est aspernatur ex consequatur similique illo at eum
                repellendus ea ullam.
                <button class="font-semibold text-blue"
        ...
        <div class="mx-4 flex flex-col gap-3 bg-white p-[16px_24px] rounded-[22px]">
            ...
            <div class="flex flex-col gap-1">
                <div class="flex items-center justify-between gap-2">
                    <div class="flex items-center gap-1">
                        <div
                            ...
                            <img src="assets/photos/pfp2.png" class="object-cover object-center w-full h-full"
                                alt="photo">
                        </div>
                        <div class="flex flex-col gap-1">
                ...
                <p class="text-sm leading-[22px] tracking-035 text-darkGrey">The view was good, also I really love the
                    weather. It’s very warm and good for healing</p>
            </div>
            <hr>
            <div class="flex gap-4">
                <div class="flex flex-col gap-3">
                    <p class="font-semibold">2.547 <span
                            class="font-normal text-sm leading-[22px] tracking-035 text-darkGrey">Reviews</span></p>
                    <div class="flex items-center">
                        ...
                        <div
                            class="w-12 h-12 border-4 border-white rounded-full overflow-hidden flex shrink-0 shadow-[6px_8px_20px_0_#00000008] -ml-2 first-of-type:-ml-1">
                            <img src="assets/photos/pfp3.png" class="object-cover object-center w-full h-full"
                                alt="photo">
                        </div>
                        <div
                            class="w-12 h-12 border-4 border-white rounded-full overflow-hidden flex shrink-0 shadow-[6px_8px_20px_0_#00000008] -ml-2 first-of-type:-ml-1">
                            <img src="assets/photos/pfp4.png" class="object-cover object-center w-full h-full"
                                alt="photo">
                        </div>
                    </div>
                </div>
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex gap-1">
                        ...
                        <div class="relative flex w-12 h-12 overflow-hidden rounded-lg shrink-0">
                            <img src="assets/thumbnails/raja.jpg" class="object-cover object-center w-full h-full"
                                alt="thumbnail">
                        </div>
                        <div class="relative flex w-12 h-12 overflow-hidden rounded-lg shrink-0">
                            <img src="assets/thumbnails/santorini.jpg" class="object-cover object-center w-full h-full"
                                alt="thumbnail">
        ...
        <div
            ...
            <div class="flex flex-col justify-center gap-1">
                ...
                <p class="text-blue font-semibold text-lg leading-[26px] tracking-[0.6px]">Rp 900.000<span
                        class="font-normal text-sx leading-[20px] tracking-035 text-darkGrey">/pack</span></p>
            </div>
            <a href="booking.html"
